...
<title>CareerConnect Portal - Register</title>
...
<div class="mb-lg">
<h3 class="font-h3 text-h3 text-on-surface mb-xs">Create an Account</h3>
<p class="font-body-sm text-body-sm text-on-surface-variant">Please select your role and choose your credentials.</p>
</div>
...
<p class="font-body-sm text-body-sm text-on-surface-variant">
                        Already have an account? <a class="text-secondary font-medium hover:underline" href="login.jsp">Login here</a>
</p>
<p class="font-body-sm text-body-sm text-on-surface-variant">
